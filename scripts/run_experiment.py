...
from genhack.configs.loader import register_schema
...
def _load_stage_registry(package: str = "genhack") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in genhack.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from genhack.configs.loader import config_to_dict, save_resolved_config
    from genhack.models.device import get_device
    from genhack.utils.logging import configure_logging
    from genhack.utils.reproducibility import set_seed
    from genhack.utils.run_manifest import create_run_dir, save_run_metadata
