...
def _registered_builder(name: str):
    ...
    try:
        module = importlib.import_module("genhack.data")
...
def main(argv: list[str] | None = None) -> int:
    ...
    from genhack.configs.loader import load_config
    from genhack.utils.run_manifest import utc_now_iso, write_json_atomic
    ...
    if builder is not None:
        ...
        source = f"genhack.data.BUILDERS[{data.name!r}]"
        ...
        print(
            ...
            "src/genhack/data/__init__.py under BUILDERS, or use data=synthetic "
