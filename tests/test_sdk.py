...
def test_public_evaluation_surface():
    from genhack import evaluation
...
def test_public_cache_surface():
    from genhack.cache import ArtifactCache

    assert callable(ArtifactCache)


def test_reporting_surface():
    from genhack import reporting
...
def test_hooks_surface():
    from genhack.models import hooks
...
def test_registry_has_revision():
    from genhack.models.registry import smallest
